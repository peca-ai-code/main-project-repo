...
function AboutPage() {
    const stats = [
        { number: "50,000+", label: "Women Served", icon: lucide_react_1.Users },
        { number: "500+", label: "Certified Doctors", icon: lucide_react_1.Heart },
        { number: "1M+", label: "AI Consultations", icon: lucide_react_1.MessageCircle },
        { number: "99.9%", label: "Uptime", icon: lucide_react_1.Shield },
    ];
    const features = [
        {
            icon: lucide_react_1.MessageCircle,
            title: "AI-Powered Health Assistant",
            description: "Get instant, personalized health insights and recommendations 24/7 with our advanced AI technology.",
    ...
    const values = [
        {
            ...
            title: "Empathy First",
            description: "We understand that women's health is personal and sensitive. Every interaction is designed with empathy and care.",
        },
        {
            icon: lucide_react_1.Shield,
            title: "Privacy & Trust",
            description: "Your health data is sacred. We maintain the highest standards of privacy and security in everything we do.",
        },
        {
            icon: lucide_react_1.Sparkles,
            title: "Innovation",
            description: "We leverage cutting-edge AI and technology to make quality healthcare more accessible and personalized.",
        },
        {
            icon: lucide_react_1.Globe,
            title: "Accessibility",
            description: "Healthcare should be available to everyone, everywhere. We're breaking down barriers to quality care.",
        },
    ];
    return (<div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-blue-50">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center space-y-8">
            <badge_1.Badge className="bg-gradient-to-r from-pink-500 to-blue-500 text-white px-6 py-3 text-lg">
              <lucide_react_1.Heart className="w-5 h-5 mr-2"/>
              About PECA
            </badge_1.Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <link_1.default href="/signup">
                <button_1.Button size="lg" className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  Join PECA Today
              ...
              <link_1.default href="/chat">
                <button_1.Button size="lg" variant="outline" className="border-2 border-blue-500 text-blue-600 hover:bg-blue-50 px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                  Try AI Assistant
                  <lucide_react_1.Sparkles className="w-6 h-6 ml-3"/>
                </button_1.Button>
              </link_1.default>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500 to-blue-500 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <badge_1.Badge className="bg-white/20 text-white border-white/30 px-4 py-2">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            return (<card_1.Card key={index} className="group border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (<card_1.Card key={index} className="group border-0 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <link_1.default href="/doctors">
                <button_1.Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-pink-500 px-10 py-6 text-xl font-semibold">
                  Find a Doctor
                  <lucide_react_1.Users className="w-6 h-6 ml-3"/>
                </button_1.Button>
              </link_1.default>
            </div>
          </div>
